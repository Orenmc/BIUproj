$(function () {
    ...
    $.widget("flowchart.flowchart", {
        ...
        consolePrint: function (nodeList) {
            ...
            let t = operators[node.op];
            console.log('Operator name is: ' + operators[node.op].properties.title);
            //run over all sons of Start
            Object.keys(node.sons).forEach(function(output){
                console.log('if ' + output + ' so do -> ' + operators[node.sons[output]].properties.title );
            });
            console.log('####');
